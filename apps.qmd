...
<div class="row g-4 mt-2">
  ...
  <div class="col-md-6">
    <div class="app-card">
      ...
      <div class="app-card-body">
        <h4 class="app-card-title">MF-AI <span class="invite-badge">INVITE ONLY</span></h4>
        ...
        <p class="app-card-text">
          <em>This is an invitation-only demo. <a href="index.qmd#contact">Email us</a> to request access.</em>
        </p>
