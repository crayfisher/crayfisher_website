...
These apps are in **beta** and under active development. Found a bug or have a request? Most apps link to their GitHub repository where you can open an issue.
:::
...
<div class="row g-4 mt-2">
  <div class="col-md-6">
    <div class="app-card">
      <a href="https://mf-ai-try.crayfisher.com" target="_blank" class="app-thumbnail-container">
        <img src="mf_ai.png" class="app-thumbnail" alt="MF-AI thumbnail">
      </a>
      <div class="app-card-body">
        <h4 class="app-card-title">MF-AI <span class="beta-badge">BETA</span></h4>
        <div class="app-card-subtitle">MODFLOW AI assistant</div>
        <p class="app-card-text">
          Describe a groundwater model in plain English — the AI assistant builds, runs, and troubleshoots a simple MODFLOW 6 model and plots the heads.
        </p>
        <p class="app-card-text">
          <em>Free to try — sign in with Google or Microsoft, no invite needed.</em>
        </p>
        <a href="https://mf-ai-try.crayfisher.com" class="btn btn-outline-primary app-btn" target="_blank">Launch App ↗</a>
      </div>
    </div>
  </div>
  <div class="col-md-6">
