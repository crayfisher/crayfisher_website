...
<div class="row g-4 mt-2">
  ...
  <div class="col-md-6">
    <div class="app-card">
      <a href="https://mf-ai.crayfisher.com" target="_blank" class="app-thumbnail-container">
      ...
      <div class="app-card-body">
        ...
        <a href="https://mf-ai.crayfisher.com" class="btn btn-outline-primary app-btn" target="_blank">Launch App ↗</a>
        <a href="https://github.com/crayfisher/MF_AI" class="btn btn-outline-secondary app-btn" target="_blank"><i class="bi bi-github"></i> Code</a>
      </div>
    </div>
  </div>
</div>
